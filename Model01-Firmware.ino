...
const Key keymaps[][ROWS][COLS] PROGMEM = {
  ...
  (Key_Escape,      Key_1, Key_2, Key_3, Key_4, Key_5, Key_Equals,
   ...
   Key_LeftControl, Key_Backspace, Key_LeftGui, Key_LeftAlt,
   ...
   Key_End,           Key_N, Key_M, Key_Comma, Key_Period, Key_Slash,     Key_Backslash,
  ...
  (Key_Sysreq, Key_F1,     Key_F2,            Key_F3, Key_F4,                Key_F5, ___,
   ...
   ___,        ___,        ___,               ___,    M(MACRO_VERSION_INFO), ___,    Key_PageUp,
   ___,        Key_Delete, Key_PcApplication, ___,
   ___,

   Consumer_ScanPreviousTrack, Key_F6,                 Key_F7,        Key_F8,                   Key_F9,                   Key_F10,          Key_F11,
   Consumer_PlaySlashPause,    Consumer_ScanNextTrack, ___,           Key_Insert,               ___,                      Key_PrintScreen,  Key_F12,
                               Key_LeftArrow,          Key_DownArrow, Key_UpArrow,              Key_RightArrow,           ___,              ___,
   Key_PageDown,               ___,                    Key_Mute,      Consumer_VolumeDecrement, Consumer_VolumeIncrement, ___,              ___,
   ___, ___, ___, ___,
   ___)
};
// *INDENT-ON*
